    ...
    <div className={props.className}>
      ...
      >
        ...
        <div className="class-author">
          <p className="p">Por</p>
          <p className="name">{course ? course.teacherID : "Severus Snape"}</p>
          <img
      ...
      <div className="container-description">
        ...
        <p className="p">{course ? course.desc : descriptionSeverus}</p>
      </div>
      <div className="container-icons">
        <div className="icon">
          <p>Avisos</p>
          <img src={ImageProvider.clase.icon_avisos} alt="icono de aviso" />
        </div>
        <div className="icon">
          <p>Correo</p>
          <img
        ...
        <div className="icon">
          <p>Alumnos</p>
          <img src={ImageProvider.clase.icon_alumnos} alt="icono de alumnos" />
        </div>
      </div>
