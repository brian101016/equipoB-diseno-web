import {Button_Menosf, Button_Masf, Button_Comentariof,Button_Editarf,Button_Agregarf} from "@components/StyledComponents";
...
function BtnDropDown() {
  ...
  return (
    ...
    <div className="dropdown">
      {
        show?<div className="dropdown-items-show">
